#------------
# The implementation of RF-net: a unified meta-learning framework for RF-enabled one-shot human activity recognition
# is based on : https://github.com/Shuheng-Li/UniTS-Sensory-Time-Series-Classification/blob/main/source/model/dual.py
...
class RFNet(nn.Module):
    ...
    def forward(self,x, till_layer="final"):
        """
...
def rf_net(seq_length=2000,num_classes=10, in_channels=30):
    return RFNet(num_classes = num_classes, input_channel = in_channels, win_len = seq_length)