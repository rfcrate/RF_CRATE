...
# the implementation of CRATE is from: https://github.com/Ma-Lab-Berkeley/CRATE
...
# we modify the following model to fit the rf data input by making the image_size, pach_size, input channels, and num_classes as arguments
...
def crate_tiny(num_classes, image_size, patch_size, in_channels=3):
    return CRATE(
...
def crate_small(num_classes, image_size, patch_size, in_channels=3):
    return CRATE(
        image_size=image_size,
        patch_size=patch_size,
        num_classes=num_classes,
...
def crate_base(num_classes, image_size, patch_size, in_channels=3):
    return CRATE(
        image_size=image_size,
        patch_size=patch_size,
        num_classes=num_classes,
...
def crate_large(num_classes, image_size, patch_size, in_channels=3):
    return CRATE(
        image_size=image_size,
        patch_size=patch_size,
        num_classes=num_classes,
