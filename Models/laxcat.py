# The implementation of LaxCat mdoel in paper: Explainable Multivariate Time Series Classification: A Deep Neural Network Which Learns to Attend to Important Variables As Well As Time Intervals.
# is based on : https://github.com/aiot-lab/RFBoost/blob/main/source/model/laxcat.py
...
def laxcat_standard(time_length, in_channels, num_classes):
    return LaxCat(input_size = time_length, input_channel = in_channels, num_label = num_classes, hidden_dim = 32, kernel_size = 64, stride = 16)
